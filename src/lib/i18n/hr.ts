...
export default {
	...
	transferCalc: {
		...
		bagLabel: 'Prtljaga',
		bagNone: 'Bez prtljage',
		bagSmall: 'Mali kofer',
		bagBig: 'Veliki kofer',
		bagSmallDim: 'do 55 × 40 × 20 cm',
		bagBigDim: 'do 75 × 50 × 30 cm',
		bagCount: 'Broj kofera',
		date: 'Datum',
		...
		modePrompt: 'Bukirajte svoju vožnju',
		quickBookTitle: 'Brza rezervacija putem WhatsAppa — cijena vidljiva odmah',
		nowToken: 'ODMAH',
		...
		// Registracija Forda još nije poznata — dodati ` · XX-000-XX` kad je Miroslav dostavi.
		mVehF: 'Ford karavan',
		mPrice: 'Cijena',
		mPax: 'Putnika',
		mBag: 'Prtljaga',
