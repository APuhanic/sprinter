...
export default {
	...
	transfersPage: {
		...
		leadTwo:
			'<p>Sprinter je obiteljska tvrtka iz Pule. Organiziramo privatne transfere i taxi vožnje u Puli, po Istri i Europi — pouzdano, točno na vrijeme, bez iznenađenja.</p><p>Za rezervaciju vožnje iz ili u zračnu luku Pula koristite naš <a href="#kalkulator">kalkulator cijene</a>.</p><p>Za taxi vožnju po Puli ili dalje, jednostavno nam pošaljite poruku.</p>',
		fleetEyebrow: 'Vozila',
	...
	transferCalc: {
		...
		fromLabel: 'Polazište',
		fromPh: 'npr. Aerodrom Pula, hotel, adresa…',
		toLabel: 'Odredište',
		toPh: 'npr. Rovinj, Opatija, adresa…',
		swap: 'Zamijeni polazište i odredište',
		routeCalculating: 'Računam rutu…',
		...
		errorRoute: 'Molimo unesite polazište i odredište.',
		...
		note: 'Napomena',
		notePh: 'Dječje sjedalo, posebni zahtjevi, dodatna stajališta…',
