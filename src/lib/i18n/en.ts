...
export default {
	...
	transferCalc: {
		...
		fromLabel: 'Pickup',
		fromPh: 'Pula Airport, hotel, address…',
		toLabel: 'Destination',
		toPh: 'Rovinj, Opatija, address…',
		...
		bagLabel: 'Baggage',
		bagNone: 'No baggage',
		bagSmall: 'Small suitcase',
		bagBig: 'Large suitcase',
		bagSmallDim: 'up to 55 × 40 × 20 cm',
		bagBigDim: 'up to 75 × 50 × 30 cm',
		bagCount: 'Number of suitcases',
		date: 'Date',
		...
		modePrompt: 'Book your ride',
		quickBookTitle: 'Quick booking via WhatsApp — price shown instantly',
		nowToken: 'NOW',
		...
		errorBaggage: 'Please select your baggage.',
		...
		// Ford plate not yet known — append ` · XX-000-XX` once Miroslav provides it.
		mVehF: 'Ford wagon',
		mPrice: 'Price',
		mPax: 'Passengers',
		mBag: 'Baggage',
