...
export default {
	...
	transferCalc: {
		...
		bagLabel: 'Gepäck',
		bagNone: 'Kein Gepäck',
		bagSmall: 'Kleiner Koffer',
		bagBig: 'Großer Koffer',
		bagSmallDim: 'bis 55 × 40 × 20 cm',
		bagBigDim: 'bis 75 × 50 × 30 cm',
		bagCount: 'Anzahl Koffer',
		date: 'Datum',
		...
		modePrompt: 'Buchen Sie Ihre Fahrt',
		quickBookTitle: 'Schnelle Buchung über WhatsApp — Preis sofort sichtbar',
		nowToken: 'SOFORT',
		...
		errorBaggage: 'Bitte wählen Sie Ihr Gepäck.',
		...
		mDest: 'Zielort',
		mVehE: 'Mercedes schwarzer Kombi · BM-979-DE',
		mVehV: 'Mercedes weißer Van · BM-507-DD',
		// Ford-Kennzeichen noch unbekannt — ` · XX-000-XX` ergänzen, sobald Miroslav es liefert.
		mVehF: 'Ford Kombi',
		mPrice: 'Preis',
		mPax: 'Personen',
		mBag: 'Gepäck',
