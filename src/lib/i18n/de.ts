...
export default {
	...
	transferCalc: {
		...
		vatNote: 'inkl. MwSt.',
		fromLabel: 'Abholort',
		fromPh: 'z. B. Flughafen Pula, Hotel, Adresse…',
		toLabel: 'Zielort',
		toPh: 'z. B. Rovinj, Opatija, Adresse…',
		swap: 'Abholort und Zielort tauschen',
		routeCalculating: 'Route wird berechnet…',
		...
		errorRoute: 'Bitte Abholort und Zielort eingeben.',
		...
		note: 'Notiz',
		notePh: 'Kindersitz, Sonderwünsche, zusätzliche Stopps…',
