export default {
	...
	cleaning: {
		...
		visionIntro:
			'Als Geschäftsführerin sehe ich meine Berufung nicht als bloßen Reinigungsservice, sondern als eine Mission, Glanz und Harmonie in Ihren Wohnraum zurückzubringen.',
		visionHospitality: 'Professioneller Hintergrund in der Hotellerie',
		visionExperience: 'Erfahrung in der Pflege exklusiver deutscher Villen und Residenzen',
		visionPersonal: 'Persönliches Engagement bei jedem Projekt',
		visionDiscipline: 'Deutsche Disziplin und absolute Diskretion',
		exclusivityTitle: 'Exklusivität ohne Kompromisse',
		exclusivityDesc:
			'Unser Service richtet sich an anspruchsvolle Kunden – Treppenhäuser, Cafés oder öffentliche Räume sind ausgeschlossen.',
		residencesTitle: 'Privatresidenzen und Architektur-Anwesen in ganz Istrien',
		residencesDesc:
			'Ihre Villa ist nicht nur eine Immobilie – sie ist Ihr Rückzugsort. Unsere Leistungen umfassen die Vorbereitung vor Ihrer Ankunft, diskrete Pflege während Ihres Aufenthalts und umfassende Instandhaltung.',
		accommodationsTitle: 'Unterkünfte der höchsten Kategorie',
		accommodationsDesc:
			'Luxuswohnungen, Boutique-Hotels, Yachten. Spezialpflege für edles Holz, Naturstein, polierte Oberflächen und empfindliche Stoffe.',
		standardsTitle: 'Standards, die ich in Ihr Zuhause bringe',
		standardTech: 'Premium-Technologie',
		standardTechDesc: 'Professionelle Kärcher-Ausstattung',
		standardDiscipline: 'Disziplin & Gesundheit',
		standardDisciplineDesc: 'Lizenzierte Fitnesstrainerin',
		pricesTitle: 'Unsere Preise',
		pricesVatNote: '(Alle angegebenen Preise verstehen sich inkl. MwSt.)',
		pricingDisclaimer:
			'Sollten die Bedingungen vor Ort den Erwartungen nicht entsprechen, wird der Preis dem tatsächlichen Aufwand angepasst.',
